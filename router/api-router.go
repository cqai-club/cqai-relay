...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		{
			modelsRoute.GET("/reconcile/preview", controller.PreviewModelReconcile)
			modelsRoute.POST("/reconcile/apply", controller.ApplyModelReconcile)
			modelsRoute.GET("/aliases", controller.GetModelAliases)
			modelsRoute.POST("/aliases/retire", controller.RetireModelAliases)
			modelsRoute.GET("/sync_upstream/preview", controller.SyncUpstreamPreview)
			modelsRoute.POST("/sync_upstream", controller.SyncUpstreamModels)
			modelsRoute.GET("/missing", controller.GetMissingModels)
			modelsRoute.GET("/", controller.GetAllModelsMeta)
			modelsRoute.GET("/search", controller.SearchModelsMeta)
			modelsRoute.POST("/:id/restore_auto", controller.RestoreModelMetadataAuto)
