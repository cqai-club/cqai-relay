    ...
    build: (settings: AuthSettings) => (
      <OAuthSection
        ...
        defaultValues={{
          ...
          'oidc.redirect_uri': settings['oidc.redirect_uri'],
          'oidc.resource': settings['oidc.resource'],
          'oidc.scope': settings['oidc.scope'],
          'oidc.admin_scope': settings['oidc.admin_scope'],
          'oidc.root_scope': settings['oidc.root_scope'],
